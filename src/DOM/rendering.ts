...
if (isBrowser && document.body === null) {
	if (process.env.NODE_ENV !== 'production') {
		throwError('you cannot run inferno without "document.body". Wait on "DOMContentLoaded" event, add script to bottom of body, or use async/defer attributes on script tag.');
	}
	throwError();
}
